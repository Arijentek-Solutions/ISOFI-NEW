...
function __OriginkitBase_AuraCursor(props: Props) {
    ...
    useEffect(() => {
        ...
        const tint = () => (live.current.backdrop === "dark" ? 0.95 : 0.85);
...
export default function AuraCursor(props: Props) {
  return <__OriginkitBase_AuraCursor {...(__originkitPresetProps as unknown as Props)} {...props} />;
}
