...
>(({ mousePos }, ref) => {
  return (
    <div
      ...
      className="absolute inset-0 pointer-events-none w-full max-w-[1920px] mx-auto px-4 sm:px-10 md:px-16 lg:px-[82px] [perspective:1400px] overflow-hidden"
    >
      {/* ========================================================================= */}
      {/* MOBILE SCREEN LAYOUT (md:hidden) — Pure Content Layer (BG is persistent) */}
      {/* ========================================================================= */}
      <div className="flex md:hidden flex-col items-center justify-center text-center w-full h-full pt-16 pb-8 px-4 relative z-20 pointer-events-auto overflow-hidden">
        {/* Headline (Centered) */}
        <div className="w-full max-w-[340px] z-20 mt-4">
        ...
        <div className="w-[130px] xs:w-[155px] h-[130px] xs:h-[155px] my-4 z-20 pointer-events-none" />

        {/* Supporting Narrative Description (Centered) */}
        <div
          data-stage2-narrative
          style={{ opacity: 0, transform: "translateY(30px)" }}
          className="w-full max-w-[320px] z-20 text-center"
        >
          <p className="font-[family-name:var(--font-onest)] font-light text-zinc-600 text-[13px] xs:text-[14px] leading-relaxed">
